...
Habitacion::Habitacion(const char* nombre, const char* descripcion, const TipoHabitacion tipoHab, Entidad* padre) :
Entidad(nombre, descripcion, padre), tipoHabitacion(tipoHab)
{
	tipo = HABITACION;
